state = { #contains state variables that apply to the player at all times
    ...
    'inventory_limit': 2, #initial inventory limit of 2, set to 6 if they aquire a backpack
    ...
    'shop_inventory': ['lantern', 'key', 'backpack', 'lambo'], #keeps track of items still avalible at the black market
